...
public class ImGuiRenderer : IDisposable
{
    ...
    public void BeginLayout(GameTime gameTime)
    {
        ...
        ImGui.GetIO().DisplaySize = new Num.Vector2(_graphicsDevice.PresentationParameters.BackBufferWidth, _graphicsDevice.PresentationParameters.BackBufferHeight);
        ImGui.NewFrame();
    }
